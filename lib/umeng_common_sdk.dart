...
class UmengCommonSdk {
  ...
  static Future<dynamic> preInit({required String appKey, required String channel}) async {
    final params = {'appKey': appKey, 'channel': channel};
    final dynamic result = await _channel.invokeMethod('preInit', params);
    return result;
  }

  static Future<dynamic> initCommon(String androidAppkey, String iosAppkey, String channel, [String? pushSecret]) async {
